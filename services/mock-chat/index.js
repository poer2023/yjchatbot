...
const { defaultModelId, getModel, models } = require("../../config/models");
const { createId } = require("../../utils/id");
const { clamp, deepClone, truncateText } = require("../../utils/helpers");
...
const GEO_SESSION_PREVIEW = "已进行三轮检索，获取了美伊冲突的军事对峙、官方声明及国际反应等多角度信息。";
...
function ensureLegalSessionPinned() {
  ...
  if (!Array.isArray(state.messagesBySession[legalSession.id]) || !state.messagesBySession[legalSession.id].length) {
